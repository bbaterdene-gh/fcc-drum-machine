...
export const Drum = () => {
  return (
    <div className="h-4/6 md:h-80 border-4 w-9/12 md:w-124 m-auto mt-28 border-yellow-400 bg-dark-gray">
      ...
      <div className="w-60 md:w-11/12 m-auto flex flex-col h-5/6 md:flex-row">
        <DrumPad />
        <DrumControl />
      </div>
    </div>
